    ...
    <footer class="sticky-footer fixed-bottom bg-white py-1">
        <div class="container my-auto">
            <div class="copyright text-center my-auto text-muted">
                <span><a href="" class="text-muted text-decoration-none" data-bs-toggle="modal" data-bs-target="#modal">Made with with <img src="{{ asset('img/hati.gif') }}" alt=""> [Nama] - [NIM]</a></span>
            </div>
        </div>
    </footer>
